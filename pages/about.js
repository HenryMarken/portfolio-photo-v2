    ...
    <React.Fragment>
      ...
      <div className="flex flex-col min-h-screen md:flex font-playfair text-2xl  md:text-3xl lg:text-4xl px-10 bg-white text-center p-10 flex justify-center items-center">
        ...
        <p className="xl:max-w-6xl lg:max-w-2xl max-w-lg  pt-10">
          I'm a recent electrical engineering graduate that does photography as
          ...
          <p className="xl:max-w-6xl lg:max-w-2xl max-w-lg py-10 flex-grow"> With photography it allows me to take a step
          back and do just so. Whenever the opportunity is presented to improve
          my skills in photography I don't shy away. I hope to do as many
